  ...
  return {
    ko: {
      template: {
        ...
        jikko_esp_set_neopixel:
          "네오픽셀 LED ( %1 핀) %2 번째 LED 색 %3 출력 %4",
        jikko_esp_set_neopixel_all:
          "네오픽셀 LED ( %1 핀) 모든 LED 색 %2 출력 %3",
    ...
    en: {
      template: {
        ...
        jikko_esp_get_digital_ultrasonic:
          "Read ultrasonic Trig %1 Echo %2 sensor value",
        ...
        jikko_esp_set_digital_dcmotor:
          "DC Motor %1 pin direction %2 %3 pin speed %4 %5",
        jikko_esp_set_neopixel_init:
          "네오픽셀 LED 시작하기 설정 ( %1 핀에 %2 개의 LED 연결) %3",
        jikko_esp_set_neopixel_bright:
          "네오픽셀 LED ( %1 핀) 밝기 %2 으로 설정 (0 ~ 255) %3",
        ...
        jikko_esp_module_digital_bluetooth:
          "Bluetooth TX 3 Pin %1 data send %2",
        jikko_esp_module_digital_oled:
          "OLED X codinate %1 Y coodinate %2 appear %3 %4",
